...
export const SURFACES: Record<string, Surface> = {
  ...
  reference: {
    ...
    lead: 'The bylaws, policies and procedures, searchable, with the discrepancy docket attached — the places where the manual disagrees with itself. This surface reads; nothing here edits the record.',
  },
  boardCalendar: {
    nav: 'Calendar',
    group: 1,
